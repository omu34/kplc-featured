...
Route::get('/single-gallery', function () {return view('home.single-gallery');});
Route::get('/category', function () {return view('home.category');});
Route::get('/latest-news', function () {return view('home.single-news');});
Route::get('/latest-gallery', function () {return view('home.single-gallery');});
Route::get('/latest-videos', function () {return view('home.single-videos');});
Route::get('/featured-news', function () {return view('home.single-featured-news');});
Route::get('/show-posts', function () {return view('home.show-post');});
Route::get('/navbar-selector', function () {return view('home.navbar-selector');});
Route::get('/footer-selector', function () {return view('home.footer-selector');});
